<x-app head-title="Создать выставку">
    <div class="container-fluid">
        <div class="row">
            <div class="col-auto">
                <h1 class="h3 mb-3"><i class="fal fa-fw fa-copyright text-secondary"></i>&nbsp;Создать выставку</h1>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <form action="/exhibitions/add" method="POST" enctype="multipart/form-data">
                        <div class="card-body">
                            @csrf
                            ...
                            <div class="d-flex justify-content-center w-100">
                                <div class="col-6 mb-4 d-flex justify-content-center">
                                    <img class="img-fluid new_logo" src="/storage/templates/pe_exhibition_template.svg" alt="Exhibition logo" id="exhibition_logo">
                                </div>
                            </div>
