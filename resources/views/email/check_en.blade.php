...
<div>
    <div class="wrapper">
        ...
        <div class="body">
            <p class="title">Confirmation of registration on MyPE</p>
            <p>To confirm registration, follow the link below.</p>
            <p>
                <a href="https://my.pe.com.ua/verify/{{ $data['id'] }}/{{ $data['code'] }}">
                    https://my.pe.com.ua/verify/{{ $data['id'] }}/{{ $data['code'] }}
                </a>
            </p>
            <p>If created account is not confirmed within 30 minutes, all the information you entered will be deleted.</p>
            <p>Thank you!</p>
        </div>
