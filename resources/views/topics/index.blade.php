<x-app head-title="Специализация">
    <div class="container-fluid">
        <div class="row">
            <div class="col-auto">
                <h1 class="h3 mb-3"><i class="fal fa-fw fa-briefcase text-secondary"></i>&nbsp;Специализация</h1>
            </div>
            <div class="col-auto ms-auto text-end">
                ...
                <ul class="dropdown-menu  dropdown-menu-end" aria-labelledby="dropdownFilter">
                    <li><a class="dropdown-item" href="{{ route('topics') }}">Все</a></li>
                    <li><a class="dropdown-item" href="{{ route('topics',['template'=>0]) }}">Активные</a></li>
                    <li><a class="dropdown-item" href="{{ route('topics',['template'=>1]) }}">Черновики</a></li>
                </ul>
