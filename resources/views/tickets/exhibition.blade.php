<x-app head-title="Билеты | {{ $exhb->name }}">
    <div class="container-fluid">
        <div class="row">
            <div class="col-auto">
                <h1 class="h3 mb-3"><i class="fal fa-fw fa-ticket text-secondary"></i>&nbsp;Билеты | <small>{{ $exhb->name }}</small></h1>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        Билеты | {{ $exhb->name }} | Всего: <strong>{{ $total }}</strong>
                    </div>
