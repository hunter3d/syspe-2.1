...
<div>
    <div class="wrapper">
        ...
        <div class="body">
            <p class="title">Підтвердження реєстрації на MyPE</p>
            <p>Щоб підтвердити реєстрацію, перейдіть за посиланням нижче.</p>
            <p>
                <a href="https://my.pe.com.ua/verify/{{ $data['id'] }}/{{ $data['code'] }}">
                    https://my.pe.com.ua/verify/{{ $data['id'] }}/{{ $data['code'] }}
                </a>
            </p>
            <p>Якщо створений обліковий запис не буде підтверджено протягом 30 хвилин, вся введена вами інформація буде видалена.</p>
            <p>Дякуємо!</p>        </div>
